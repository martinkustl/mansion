...
class FacilitySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $facilities = [
            ['id' => 1, 'name' => 'Koncertní a divadelní sály', 'description' => $dummyDesc],
            ['id' => 2, 'name' => 'Relaxace', 'description' => $dummyDec2],
            ['id' => 3, 'name' => 'Sportoviště a volný čas', 'description' => $dummyDesc],
            ['id' => 4, 'name' => 'Svatba', 'description' => $dummyDec2],
            ['id' => 5, 'name' => 'Ubytování', 'description' => $dummyDesc]
        ];
