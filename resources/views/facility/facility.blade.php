...
<div id="facilityCarousel" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-indicators">
        ...
        <button type="button" data-bs-target="#facilityCarousel" data-bs-slide-to={{"$loop->index"}} aria-label={{"Slide $loop->index+1"}} 
            @class([
                'active' => $loop->index == 0
            ])
            />
    ...
    <ul class="carousel-inner">
      ...
      @foreach ($facility->images as $image)
        ...
        >
            <img class="d-block w-100 c-carousel-img" src="/images/{{$image->folderName.'/'.$image->staticFileId.$image->extension}}"/>
        </li>
      @endforeach
    </ul>
